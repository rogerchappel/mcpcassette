...
Replace this section with the supported versions for `mcpcassette`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `mcpcassette` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in mcpcassette.
